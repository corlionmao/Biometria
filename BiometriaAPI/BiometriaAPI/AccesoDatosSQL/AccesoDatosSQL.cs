...
namespace AccesoDatosSQL
{
    public class AccesoDatosSQL
    {
        ...
        public AccesoDatosSQL(string stringConexion)
        {
        ...
        public void CrearComandoSParam(string nombreSP, SqlCommand cmd)
        {
            this._comando = new SqlCommand();
        ...
        public void CrearComandoSP(string nombreSP, SqlCommand cmd)
        {
            this._comando = new SqlCommand();
            cmd.Connection = this._conexion;
            cmd.CommandText = nombreSP;
        ...
        public DataTable EjecutarConsultaDT(string stringSQL)
        {
            ...
            adapter.SelectCommand = new SqlCommand(stringSQL, this._conexion);
            adapter.Fill(dt);
            cerrarConexion();
            return dt;
        }
        ...
        public DataSet EjecutarConsultaDataSet(string stringSQL, string nombreTabla)
        {
            ...
            SqlDataAdapter adapter = new SqlDataAdapter(stringSQL, this._conexion);
            ds.Clear();
        ...
        public int EjecutarComandoRegsAct()
        {
        ...
        public int EjecutaQryRegsAct(string stringSQL)
        {
            try
            {
                int registros;
                ...
                //ComenzarTransaccion();
                CrearComando(stringSQL);
                registros = EjecutarComandoRegsAct();
                //ConfirmarTransaccion();
                cerrarConexion();
                return registros;
            }
        ...
        public void EjecutaQrySParam(string nombreSP, SqlCommand cmd)
        {
            try
            {
                abrirConexion();
